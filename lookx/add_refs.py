...
MATCH_HINTS = {
    ...
    # New prospects
    "j__fort": ["novig", "sport", "prediction", "market", "bet"],
    "Domahhhh": ["polymarket", "predict", "market", "bet", "odds"],
    "nigeleccles": ["fanduel", "betdex", "bethog", "bet", "sport", "gambl"],
    "Tristan0x": ["perp", "bullet", "zeta", "solana", "derivative"],
    "AntonioMJuliano": ["dydx", "perp", "builder code", "prediction"],
    "rleshner": ["polymarket", "compound", "superstate", "defi"],
    "jessewldn": ["perp", "variant", "prediction", "market"],
    "masonnystrom": ["prediction", "market", "variant", "betting"],
    "_charlienoyes": ["prediction", "market", "kalshi", "paradigm"],
    "adamscochran": ["prediction", "market", "defi", "perp"],
    "NateSilver538": ["polymarket", "prediction", "market", "forecast"],
    "davijlu": ["drift", "predict", "bet", "solana"],
    "richkleiman": ["sport", "basketball", "kd", "durant"],
    "gametheorizing": ["poker", "market", "prediction", "selini"],
    "jack__sanford": ["flash", "perp", "solana", "trade"],
    "y2kappa": ["kamino", "derivative", "solana", "defi"],
    "mdudas": ["solana", "6mv", "sport", "linksdao"],
    "kaiynne": ["synthetix", "infinex", "perp", "solana"],
    "rajgokal": ["solana", "tbd", "predict", "angel"],
    "lessin": ["tbd", "solana", "predict", "market"],
    "mattytay": ["colosseum", "solana", "fund"],
    "QwQiao": ["prediction", "market", "telegram", "alliance"],
    "mariogabriele": ["prediction", "market", "krug", "novig"],
    "tarunchitra": ["perp", "adl", "gauntlet", "hyperliquid"],
    "ZeMariaMacedo": ["perp", "poker", "delphi", "tradfi"],
    "shaughnessy119": ["perp", "tradfi", "delphi"],
    "pierskicks": ["gaming", "crypto", "sport", "esport"],
    "cburniske": ["solana", "placeholder", "defi"],
    "jmonegro": ["solana", "defi", "fat protocol"],
    "ljin18": ["ownership", "economy", "variant", "creator"],
    "spencernoon": ["solana", "perp", "drift", "jupiter", "ournetwork"],
    "lalleclausen": ["perp", "solana", "defi", "1kx"],
    "pet3rpan_": ["gaming", "nft", "1kx", "entertainment"],
    "avichal": ["solana", "electric", "zeta", "perp"],
    "mariashen": ["solana", "electric", "developer"],
    "diogomonica": ["anchorage", "tradfi", "defi", "near"],
    "ahnchrisj": ["haun", "defi", "conduit", "infra"],
    "ed_roman": ["hack", "crypto", "perp", "solana"],
    "roshunpatel": ["defi", "genesis", "perp", "derivative"],
    "stefancoh": ["bain", "crypto", "defi", "game"],
    "sethgrosenberg": ["greylock", "consumer", "gaming", "marketplace"],
    "PrimordialAA": ["layerzero", "poker", "fomo", "cross-chain"],
    "armaniferrante": ["backpack", "anchor", "solana", "perp"],
    "StaniKulechov": ["aave", "infinex", "defi"],
    "buffalu__": ["jito", "mev", "solana", "defi"],
    "blknoiz06": ["solana", "angel", "meme"],
    "Fiskantes": ["zee prime", "defi", "crypto"],
    "nemild": ["yc", "totalis", "solana", "stablecoin"],
    "calilyliu": ["solana", "prediction", "market", "foundation"],
    "Austin_Federa": ["solana", "doublezero", "validated", "perp"],
    "kashdhanda": ["superteam", "solana", "angel"],
    "nate_levine": ["colosseum", "solana", "stripe"],
    "YanLiberman": ["delphi", "perp", "tradfi"],
    "ricomallozzi": ["sport", "359", "consumer", "gaming"],
    "therealchaseeb": ["solana", "dev", "luminal"],
    "akshaybd": ["solana", "superteam", "foundation"],
    "LucaNetz": ["pudgy", "penguin", "nascar", "sport"],
}
